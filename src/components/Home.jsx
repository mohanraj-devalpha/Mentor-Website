  ...
  return (
    <div>
        <div className='flex flex-col justify-evenly bg-[#FFFFFF] overflow-hidden border-2 my-5 min-[1400px]:my-20 mx-5 min-[1400px]:mx-20 '>
            ...
            <div className='grid grid-cols-1 min-[1400px]:grid-cols-2 max-[1400px]:gap-10 py-10'>
                <div className=' border-t border-r '>
                        ...
                        <div className="rounded-xl grid grid-cols-1 md:grid-cols-2  mt-10 md:mt-15 mx-5 md:mx-20 border-2 border-[#333333] p-5">
